...
namespace MAIN
{
    unsafe class ExternalFunctions
    {
        ...
        public static extern double test_c(double a, double b);

        internal static void computeMatrixU_ASM(double[] matrixU, int size)
        {
        ...
        internal static void computeMatrixL_ASM(double[] matrixL, double[] matrixU, int size)
        {
            for (int k = 0; k < size - 1; k++)
                for (int i = k + 1; i < size; i++)
        ...
        internal static void computeVectorY_ASM(double[] vectorY, double[] vectorB, double[] matrixL, int size)
        {
            vectorY[0] = vectorB[0];
        ...
        internal static void computeVectorX_ASM(double[] vectorX, double[] vectorY, double[] matrixU, int size)
        {
